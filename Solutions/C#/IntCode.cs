...
namespace AoC2019
{
    public class IntCode
    {
        ...
        public long GetOutput() => CurrentOutput;
        ...
        {
            long firstParamMode = CurrentOpCode / (long)Math.Pow(10, paramNr + 1) % 10;
